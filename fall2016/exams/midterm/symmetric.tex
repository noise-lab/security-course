...
%  \textit{Answer:} The best fix is to add padding and then do OAEP encoding. 
% Another possible but not ideal fix could be to increase Bob's public exponent size and perhaps lower the size of $N$ This solution requires changing the public key, thus it is not very practical.
