...
The TV study found the same pattern on streaming platforms. Also cite the **FTC's May 2023
Ring/Alexa settlements** (Amazon paid $31M total: $5.8M for Ring letting employees browse
customer bedroom cameras; $25M for Alexa retaining children's voice recordings in
violation of COPPA — Amazon barred from training models on data users deleted). This is
the bridge to the privacy-law lectures: a technical measurement finding maps directly
onto a legal regime (COPPA) and a concrete penalty.
:::
...
lectures, where these findings become legal arguments. Regulatory horizon worth naming:
the **EU Cyber Resilience Act** (in force Dec 10, 2024; reporting duties from
**Sept 11, 2026**; full obligations Dec 11, 2027) classes connected toys as Class I
"important products with digital elements"; the **EU AI Act** brings AI-enabled toys under
its high-risk regime (application dates now Aug 2, 2027 / Dec 2, 2027 after the June 2026
"Digital Omnibus on AI"). U.S. side: the **U.S. Cyber Trust Mark** is a voluntary label,
not a mandate.
:::
