...
The PQ bullet answers the "harvest now, decrypt later" concern — D-H's discrete-log
hardness assumption breaks against a quantum adversary, so the industry is already
migrating. Hybrid means classical + PQ in the same handshake; safe if either survives.
:::
