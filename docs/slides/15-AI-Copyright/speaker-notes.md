...
- Market substitution argument (summaries vs. purchases)
- Lost advance/royalty income claims
- Professional practice disruption

**Rhetorical framing by authors:**
- Training data use without compensation
- Lifetime of work incorporated into models
...
**The Claude lawsuit:**
- Anthropic is the company that created Claude
- Filed October 2023
...
**Note for class:**
- Claude now refuses to reproduce copyrighted lyrics
- Models have implemented filters since this lawsuit
- Example of how litigation affects AI behavior
...
- Here, creators present evidence of market effects (surveys, economic analysis)
...
4. **Claimed market effects**
   - Survey evidence presented
   - Artist testimony regarding commissions
   - Licensing revenue arguments
...
**Compensation side (creators argue):**
...
- Economic distribution: AI companies profit from creator contributions

**Both perspectives may have merit:**
- AI provides value for society
- Creators face business model disruption
- Courts will balance these interests
...
- **Creators:** Uncertain legal status, ongoing litigation
...
7. Courts will balance innovation and compensation interests
...
**Legal Analysis:**
- Stanford Law Review: "Generative AI Has an Intellectual Property Problem" - [Stanford Law Review: "Generative AI Has an Intellectual Property Problem"](https://law.stanford.edu/2023/02/17/generative-ai-ip-problem/)
- Columbia Law Review: "Fair Learning" - [Columbia Law Review: "Fair Learning"](https://columbialawreview.org/content/fair-learning/)
...
- "Resolved: The benefits of generative AI to society outweigh any economic disruption to creators."
