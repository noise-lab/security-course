...
"TurboMirai" descendant. 31.4 Tbps vs. the ~1 Tbps Dyn attack — 30× in a
decade. The 35-second duration matters: modern attacks are short, sharp, and
automated, so defenses must be too. Aisuru also targeted KrebsOnSecurity (6.35
Tbps, May 2025) — the same target Mirai took offline in 2016. Sources:
Cloudflare Q4 2025 DDoS threat report; DoJ press release, Mar 19 2026; XLab /
Lumen research. Coda: analysts warn scanning from new C2 infrastructure was
already observed within weeks of the takedown — the botnet cycle continues.
:::
