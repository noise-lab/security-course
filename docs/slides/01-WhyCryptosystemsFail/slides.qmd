...
## Where Does It Actually Break? {.center}

> We just saw you can't fully trust code you didn't write. Now the term's
> second question: when a "secure" system fails, **where** does it break?

Today: **Why Cryptosystems Fail** (Anderson, 1993) — the failure is almost
never the math.

::: {.notes}
Follows the Trusting Trust segment that closes the overview deck. Frame
Anderson as the empirical answer to the question Thompson raised in theory:
here is where real deployed systems actually broke. Don't lecture the paper
line by line — pull out the durable ideas.
:::
