...
wire but made the trust/availability problem worse by concentrating it, on two
axes: availability (AWS Oct 2025) and coercion (Italy AGCOM Jan 2026, French
appeals Mar 2026). Sources: TorrentFreak coverage, Cloudflare blog "Standing up
for the open Internet." Note: same court, same term, upheld ISP-level DNS
blocking too — the block moved *up* to the public resolvers precisely because
users had escaped ISP resolution.
:::
