...
\sols{\textit{Answer:} Asymmetric cryptography is more computationally expensive than symmetric cryptography.}
...
\sols{\textit{Answer:} $A \xrightarrow{\{M\}_{S\_A}} B$} 
...
\sols{\textit{Answer:} $A \xrightarrow{\{M\}_{P\_B}} B$}

\item Using public key cryptography, design a message that enables Bob to
verify the message source, Alice, and when both integrity and
confidentiality are protected.

\sols{\textit{Answer:} $A \xrightarrow{\{\{M\}_{P\_B}\}_{S\_A}\}} B$}
